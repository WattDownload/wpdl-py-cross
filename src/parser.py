...
# Replace the old clean_tree function with this entire block
...
""",
    ...
    # This is the corrected logic with proper indentation
    body_tag = original_soup.find("body")
    if not body_tag:
        # If there's no body content, just return the chapter with the title
        return new_soup

    # This loop has the correct indentation
    for tag in cast(list[Tag], list(body_tag.children)):
